...
void clear(struct datos *pieza, ALLEGRO_BITMAP *colores[8], int x)
{
    al_draw_bitmap(colores[0], pieza->centro_pos[0]*21+(21*x), pieza->centro_pos[1]*21, 0);
    al_draw_bitmap(colores[0], pieza->periferico_1_pos[0]*21+(21*x), pieza->periferico_1_pos[1]*21, 0);
    al_draw_bitmap(colores[0], pieza->periferico_2_pos[0]*21+(21*x), pieza->periferico_2_pos[1]*21, 0);
    al_draw_bitmap(colores[0], pieza->periferico_3_pos[0]*21+(21*x), pieza->periferico_3_pos[1]*21, 0);
}
...
void print(struct datos *pieza, ALLEGRO_BITMAP *colores[8], int x)
{
    int i;
    ...
    al_draw_bitmap(colores[i], pieza->centro_pos[0]*21+(21*x), pieza->centro_pos[1]*21, 0);
    al_draw_bitmap(colores[i], pieza->periferico_1_pos[0]*21+(21*x), pieza->periferico_1_pos[1]*21, 0);
    al_draw_bitmap(colores[i], pieza->periferico_2_pos[0]*21+(21*x), pieza->periferico_2_pos[1]*21, 0);
    al_draw_bitmap(colores[i], pieza->periferico_3_pos[0]*21+(21*x), pieza->periferico_3_pos[1]*21, 0);
}
